...
entrypoint: None()
actions: ['SetFacialExpression', 'PlayAnimation', 'SetDefaultFacialExpression', 'SetInstanceVariableString', 'AimPlayer', 'PlayAnimationNoWait', 'Deactivate', 'MoveToCompassPoint', 'AimActor', 'WarpToActor', 'ResetAim', 'SetCollisionEnabled', 'SetGravityEnable', 'AimToLocation']
queries: []
params: None

Actor: EvHyruleSoldier008
entrypoint: None()
actions: ['PlayAnimation', 'SetFacialExpression', 'SetDefaultFacialExpression', 'SetInstanceVariableString', 'AimPlayer', 'PlayAnimationNoWait', 'Deactivate', 'MoveToCompassPoint', 'AimActor', 'WarpToActor', 'ResetAim', 'SetCollisionEnabled', 'SetGravityEnable', 'AimToLocation']
queries: []
params: None
