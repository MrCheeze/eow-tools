...
Actor: Player
entrypoint: None()
actions: ['MoveToCompassPoint', 'AimCompassPoint', 'AimActor', 'SetInterestIkEnabled']
queries: []
params: None
...
Actor: Partner
entrypoint: None()
actions: ['MoveToBesideTargetActor', 'AimCompassPoint', 'AimActor', 'SetInterestIkEnabled']
queries: []
params: None
        ...
        if !StoneMonumentNorthForest.CheckActorSwitch({'switchIndex': 0}) {
            ...
            if !StoneMonumentNorthForest.CheckActorSwitch({'switchIndex': 1}) {
                ...
                fork {
                    ...
                    Player.MoveToCompassPoint({'speed': 0, 'withoutTurn': True, 'direction': 0, 'distance': 1.5, 'tolerance': 0.0, 'timeOut': 7.0, 'customSpeed': 0.0, 'method': 0, 'offsetX': 0.0, 'offsetY': 0.0})
