...
entrypoint: None()
actions: ['GenericTalkSequenceWithDialog', 'Talk', 'PlayAnimation', 'PlayOneshotSE', 'PlayAnimationEx', 'PlayAnimationNoWait', 'CatDoAcitonWait', 'LookAtTalker', 'GenericTalkSequence']
queries: []
params: None
