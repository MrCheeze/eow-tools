...
Actor: Audio
entrypoint: None()
actions: ['StopZoneBgm', 'StopAllBGM', 'PlayBGM', 'WaitNextBeatSamplePositionAndStopAndPlayBossJungleBgm', 'WaitNextBeatSamplePositionAndStopAndPlayBossJungleBridgeBgm', 'PlayOneshotSystemSE', 'StopZoneBaseAmbience']
queries: []
params: None
...
void Angry() {
    ...
    fork {
        Audio.WaitNextBeatSamplePositionAndStopAndPlayBossJungleBgm({'label': 'BGM_BATTLE_BOSS_JUNGLE_BRIDGE', 'stoplabel': 'BGM_BATTLE_BOSS_JUNGLE'})
        ...
        Audio.WaitNextBeatSamplePositionAndStopAndPlayBossJungleBridgeBgm({'stoplabel': 'BGM_BATTLE_BOSS_JUNGLE_BRIDGE', 'label': 'BGM_BATTLE_BOSS_JUNGLE2'})
